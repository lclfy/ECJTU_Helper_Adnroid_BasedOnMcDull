...
public class IconHelper {
     ...
     */
    public static void getIcon(final Context context, final GetIconCallBack callBack) {
        Bitmap bitmap = null;
        try {
                    ...
                    file.getDataInBackground(new GetDataCallback() {
                        ...
                        public void done(byte[] bytes, AVException e) {
                            if (bytes != null) {
                                ...
                                try {
                                    FileOutputStream fos = context.openFileOutput("Icon.png", Context.MODE_PRIVATE);
                                    fos.write(bytes);
                                    fos.close();
